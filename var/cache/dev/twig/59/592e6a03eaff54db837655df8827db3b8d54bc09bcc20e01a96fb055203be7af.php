...
class __TwigTemplate_4c875558a8c14ba1b926661fa509dd1e349a133fd0bb57f181f7c11e24e88f38 extends \Twig\Template
{
      ...
      <div class=\"card-block row\">
        ...
        echo "</label>
            <div class=\"col-sm\">
              ";
        // line 39
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "default_carrier", []), 'errors');
        echo "
              ";
        // line 40
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "default_carrier", []), 'widget');
        echo "
        ...
        echo "</label>
            <div class=\"col-sm\">
              ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "carrier_default_order_by", []), 'errors');
        echo "
              ";
        // line 48
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "carrier_default_order_by", []), 'widget');
        echo "
              <small class=\"form-text\">";
        // line 49
        ...
        echo "</label>
            <div class=\"col-sm\">
              ";
        // line 55
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "carrier_default_order_way", []), 'errors');
        echo "
              ";
        // line 56
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["carrierOptionsForm"] ?? $this->getContext($context, "carrierOptionsForm")), "carrier_default_order_way", []), 'widget');
        echo "
              <small class=\"form-text\">";
        // line 57
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("This will only be visible in the front office.", [], "Admin.Shipping.Help"), "html", null, true);
...
{% endblock %}
", "@PrestaShop/Admin/Improve/Shipping/Preferences/Blocks/shipping_preferences_carrier_options.html.twig", "C:\\wamp64\\www\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Improve\\Shipping\\Preferences\\Blocks\\shipping_preferences_carrier_options.html.twig");
    }
}
