...
class __TwigTemplate_bcd4eb469a262a1a09598ffcdd12642ca5a59e5859498b94e06bf0608df91eb1 extends \Twig\Template
{
    ...
    ";
        ...
        ";
            ...
            echo "',
                apiStockUrl: '";
            // line 55
            echo twig_escape_filter($this->env, ((($context["productId"] ?? $this->getContext($context, "productId"))) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_product_combinations", ["productId" => ($context["productId"] ?? $this->getContext($context, "productId"))])) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_products"))), "html", null, true);
            echo "',
                apiMovementsUrl: '";
            // line 56
            echo twig_escape_filter($this->env, ((($context["productId"] ?? $this->getContext($context, "productId"))) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_product_list_movements", ["productId" => ($context["productId"] ?? $this->getContext($context, "productId"))])) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_movements"))), "html", null, true);
            echo "',
                employeesUrl: '";
            // line 57
...
{% endblock %}
", "@PrestaShop/Admin/Stock/overview.html.twig", "C:\\wamp64\\www\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Stock\\overview.html.twig");
    }
}
