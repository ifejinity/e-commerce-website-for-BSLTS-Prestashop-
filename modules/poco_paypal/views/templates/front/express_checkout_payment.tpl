...
<!--p class="payment_module"-->
	<a href="javascript:void(0)" onclick="validate_adn(document.adn_form, 2);" id="paypal_process_payment" title="{l s='Pay with PayPal' mod='paypal'}">
		{*}
		...
		{/if}
		{*}
		<img id="checkout_paypal" src="{$img_dir}card_3.jpg" />		
	</a>
<!--/p-->
