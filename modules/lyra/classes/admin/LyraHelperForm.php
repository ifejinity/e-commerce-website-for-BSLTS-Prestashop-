...
class LyraHelperForm
{
    ...
    public static function getAdminFormContext()
    {
        ...
        $tpl_vars = array(
            ...
            'lyra_formatted_support_email' => LyraApi::formatSupportEmails(LyraTools::getDefault('SUPPORT_EMAIL')),
            'lyra_plugin_version' => LyraTools::getDefault('PLUGIN_VERSION'),
            'lyra_gateway_version' => LyraTools::getDefault('GATEWAY_VERSION'),
            'lyra_contrib' => LyraTools::getContrib(),
            'lyra_installed_modules' => LyraTools::getModulesInstalled(),
            'lyra_card_data_entry_modes' => LyraTools::getCardDataEntryModes(),
            'lyra_employee' => $context->employee,
            ...
            'lyra_card_data_mode_options' => array(
                ...
                '5' => $lyra->l('Embedded payment fields on merchant site (REST API)', 'lyrahelperform'),
                '6' => $lyra->l('Embedded payment fields in a pop-in (REST API)', 'lyrahelperform')
            ),
            ...
            'lyra_default_franfinance_option' => array(
                'label' => '',
                'count' => '3',
                'fees' => '-1',
                'min_amount' => '100',
            ...
            'fees_options' => array(
                '-1' => $lyra->l('Bank Back Office configuration', 'lyrahelperform'),
                '0' => $lyra->l('Without fees', 'lyrahelperform'),
                '1' => $lyra->l('With fees', 'lyrahelperform')
            ),
            ...
            'lyra_default_extra_payment_means_option' => array(
                'code' => '',
                'title' => ''
            ),
            ...
            'LYRA_ENABLE_CUST_MSG' => Configuration::get('LYRA_ENABLE_CUST_MSG'),
            ...
            'LYRA_REST_SERVER_URL' => Configuration::get('LYRA_REST_SERVER_URL'),
            'LYRA_REST_JS_CLIENT_URL' => Configuration::get('LYRA_REST_JS_CLIENT_URL'),
            ...
            'LYRA_STD_CARD_DATA_MODE' => Configuration::get('LYRA_STD_CARD_DATA_MODE') ?
                                            Configuration::get('LYRA_STD_CARD_DATA_MODE') : '1',
            'LYRA_STD_REST_THEME' => Configuration::get('LYRA_STD_REST_THEME'),
            'LYRA_STD_REST_PLACEHLDR' => $placeholders,
            'LYRA_STD_REST_LBL_REGIST' => self::getLangConfig('LYRA_STD_REST_LBL_REGIST'),
            ...
            'LYRA_FFIN_TITLE' => self::getLangConfig('LYRA_FFIN_TITLE'),
            'LYRA_FFIN_ENABLED' => Configuration::get('LYRA_FFIN_ENABLED'),
            'LYRA_FFIN_AMOUNTS' => self::getArrayConfig('LYRA_FFIN_AMOUNTS'),
            'LYRA_FFIN_OPTIONS' => self::getArrayConfig('LYRA_FFIN_OPTIONS'),
            ...
            'LYRA_SEPA_1_CLICK_PAYMNT' => Configuration::get('LYRA_SEPA_1_CLICK_PAYMNT'),
            ...
            'LYRA_EXTRA_PAYMENT_MEANS' => self::getArrayConfig('LYRA_EXTRA_PAYMENT_MEANS')
        );
        ...
        if (! LyraTools::$plugin_features['embedded']) {
            unset($tpl_vars['lyra_card_data_mode_options'][LyraTools::MODE_EMBEDDED]);
            unset($tpl_vars['lyra_card_data_mode_options'][LyraTools::MODE_POPIN]);
        }
