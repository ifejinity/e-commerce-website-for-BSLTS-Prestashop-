...
class LyraFranfinancePayment extends AbstractLyraPayment
{
    protected $prefix = 'LYRA_FFIN_';
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('LYRA_FFIN_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['lyra_ffin_options'] = self::getAvailableOptions($cart);
